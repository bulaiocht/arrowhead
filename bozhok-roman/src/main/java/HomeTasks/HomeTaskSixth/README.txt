На основе домашнего задания #2 (Фигуры, Теугольники, Круги...)
1. Модифицировать классы таким образом чтобы точки фигур хранились в коллекциях.
Если нужно переделать структуру наследования в соответствии со своими нуждами.

2. Создать утилитный класс в котором будет:
